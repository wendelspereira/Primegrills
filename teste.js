const products = [
    ...
    {
        "_id": "60babff3b12c2c01fc633cfd",
        "category": "PRIME ARTESANAL",
        "name": "PRIME EGG",
        "cardDescription": "",
    ...
    {
        "_id": "60babff3b12c2c01fc633d02",
        "category": "PRIME ESPECIAL",
        "name": "PRIME SIMPLE",
        "cardDescription": "",
    ...
    {
        "_id": "60babff3b12c2c01fc633d08",
        "category": "PRIME INSDUSTRIAL",
...
const noRepeatedCategory = allCategories.filter((item, index) => allCategories.indexOf(item) === index)

const productsByCategory = {}

noRepeatedCategory.map((item)=>{
    productsByCategory[`${item}`] = products.filter(product=>product.category === item)
})
